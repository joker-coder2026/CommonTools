...
#pragma region CSLocker
	// CSLocker �� CriticalSectionLocker
	class CSLocker
	{
	public:
...
#pragma region CustomSettings
	...
	public:
		...
		/**
		 * @brief 重命名JSON文件
		 * @param [in] oldFileName - 旧文件名
		 * @param [in] newFileName - 新文件名
		 * @return 重命名结果
		 **/
		 ...
		 * @brief 将JSON转换为向量
		 * @param [in] fileName - 文件名
		 * @param [out] currentFileData - 输出参数
		 * @return 转换结果
		 **/
		...
		/**
		 * @brief 移除JSON对象
		 * @param [in] objectPath - 对象路径，格式：fileName/section/key
		 * @return 移除结果
		 **/
